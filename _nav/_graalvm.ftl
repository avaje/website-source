<ul>
<@smallnav activeCheck="${graalvm!''}" url="/graalvm" title="Overview">
  <ul class="nav nav-scroll">
    <@nav url="#why" title="Why GraalVM native image?"></@nav>
    <@nav url="#avaje-and-graalvm" title="How do Avaje Libraries help?"></@nav>
    <@nav url="#considerations" title="Considerations"></@nav>
  </ul>
</@smallnav>
